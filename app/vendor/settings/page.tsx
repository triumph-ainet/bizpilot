...
export default function SettingsPage() {
      ...
      items: [
        {
          ...
          bg: 'bg-emerald-50',
          label: 'Business Name',
          value: displayedSettings.businessName,
          editable: true,
        },
        {
          id: 'phone',
        ...
        },
        {
          ...
          bg: 'bg-pink-50',
          label: 'Store Link',
          value: displayedSettings.storeSlug
            ? `${window.location.origin}/store/${displayedSettings.storeSlug}`
            : '',
          editable: false,
          copyable: true,
        },
      ...
      items: [
        {
          ...
          bg: 'bg-purple-50',
          label: 'Bank Account',
          value: displayedSettings.accountVerified
            ? `${displayedSettings.bankName} · ****${displayedSettings.accountNumber?.slice(-4)} · Verified ✓`
            : 'Not set',
          editable: true,
          isBankDetails: true,
        },
        {
          ...
          value: `Alert when below ${displayedSettings.lowStockThreshold} units`,
          editable: true,
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen bg-cream pb-24">
      <Header settings={displayedSettings} isLoading={loading} />

      <div className="px-6 py-5 space-y-4">
        {loading && <SettingsSkeleton />}

        {!loading && !settings && (
          <div className="text-center px-6 py-8 bg-white rounded-2xl shadow-card">
