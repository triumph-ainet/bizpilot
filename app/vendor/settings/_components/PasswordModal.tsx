...
import { PasswordChangeForm } from '../_types';
    ...
    <div className="fixed inset-0 bg-black/50 flex items-end z-50">
      <div className="w-full bg-white rounded-t-3xl px-6 py-6 animate-in slide-in-from-bottom">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={onClose} className="text-ink-light text-2xl">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        {success && (
          <p className="text-green text-sm bg-green/10 rounded-xl px-4 py-3 mb-4">{success}</p>
        )}
