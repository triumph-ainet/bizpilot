                  ...
                  {item.isBankDetails ? (
                    <div className="space-y-3">
                      <input
                        ...
                        onChange={(e) => onEditChange('bankName', e.target.value)}
                      ...
                      <input
                        ...
                        onChange={(e) => onEditChange('bankCode', e.target.value)}
                        className="w-full px-3 py-2 border border-cream-dark rounded-lg text-sm"
                      />
                      <input
                        type="text"
                        ...
                        onChange={(e) => onEditChange('accountNumber', e.target.value)}
                        className="w-full px-3 py-2 border border-cream-dark rounded-lg text-sm"
                      />
                      <input
                        type="text"
                        ...
                        onChange={(e) => onEditChange('accountName', e.target.value)}
                        className="w-full px-3 py-2 border border-cream-dark rounded-lg text-sm"
                      />
                    </div>
                  ) : (
